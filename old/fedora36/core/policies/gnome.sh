...
cp /etc/gdm/custom.conf custom.conf
...
#echo "banner-message-text='Hello World'" >> /etc/gdm/greeter.dconf-defaults
#echo "disable-user-list=true" >> /etc/gdm/greeter.dconf-defaults
